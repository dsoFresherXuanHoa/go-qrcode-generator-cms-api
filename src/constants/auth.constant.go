...
var (
	...
	MissingEmailInQueryString          = "Missing email in query string: email must be in email format"
	...
	ErrResetPassword                  = "Error while reset user password: make sure you have right permission and try again later!"
	ErrUserNotFound                   = "Error while find user by email: user not exists, check your email and try again!"
	ErrSendResetPasswordRequestEmail  = "Error while send reset password email to user: make sure you send correct email address!"
	ErrMapOAuthResponse2UserCreatable = "Error while map OAuth response to User Creatable struct: check your Google Authentication Scope or accessToken to make sure you have right permission!"
	ErrSignInUsingGoogle              = "Error while sign in or sign up using Google account: you cannot have right permission, contact to administrator to get more information!"
	...
	ResetPasswordSuccess                 = "Reset password success: congrats!!!"
	SendResetPasswordRequestEmailSuccess = "Send reset password request email success: check your mail income to get more detail!!!"
	SignInUsingGoogleSuccess             = "Sign in or sign up using Google account success: congrats!!!"
)
